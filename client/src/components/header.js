            ...
            h('div.group-right', [
                ...
                h('div.h-col-3', [
                    ...
                    h('button.h-search', {
                        ...
                        attrs: { 'data-tooltip': translate(model.settings.language, 'header.recherche'), 'aria-label': translate(model.settings.language, 'header.recherche') }
                    }, [rechercheIcon]),
                    // --- Bouton Paramètres ---
                    h('button.settings', {
                    ...
                    h('button.notification', {
                        ...
                        attrs: { 'data-tooltip': translate(model.settings.language, 'header.notifications'), 'aria-label': translate(model.settings.language, 'header.notifications') }
                    }, [h('svg', { attrs: { viewBox: "0 0 24 24", width: "24px", height: "24px", fill: "var(--white2)" } }, [
